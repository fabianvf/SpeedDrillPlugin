...
{
	gameWrapper->HookEventWithCaller<CarWrapper>("Function TAGame.Car_TA.OnRigidBodyCollision", std::bind(&SpeedDrillPlugin::OnHitBallPre, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3));
...
RelevantData latest;
void SpeedDrillPlugin::OnHitBallPre(CarWrapper cw, void * params, std::string eventName)
{
